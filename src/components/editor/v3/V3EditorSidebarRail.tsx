...
export function V3EditorSidebarRail() {
  ...
  const navItems = [
    { id: 'add' as const, label: 'Add', icon: <Plus className="w-5 h-5" /> },
    { id: 'layers' as const, label: 'Layers', icon: <Layers className="w-5 h-5" /> },
    { id: 'pages' as const, label: 'Pages', icon: <FileText className="w-5 h-5" /> },
    { id: 'site' as const, label: 'Site', icon: <Globe className="w-5 h-5" /> },
    { id: 'theme' as const, label: 'Design', icon: <Palette className="w-5 h-5" /> },
    { id: 'assets' as const, label: 'Assets', icon: <FolderOpen className="w-5 h-5" /> },
  ];
